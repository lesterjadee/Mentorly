  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/dashboard/services/new" className="flex items-center gap-2 bg-[#26619C] hover:bg-[#1e4f82] transition-colors px-4 py-2.5 rounded-xl text-sm font-medium">
          <Plus size={16} />
          New service
        </Link>
      </div>
      ...
      {services && services.length > 0 ? (
        <div className="grid gap-4">
          {services.map((service) => (
            <div key={service.id} className="bg-white/3 border border-white/8 rounded-2xl p-6 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href={`/dashboard/services/${service.id}/edit`} className="p-2 text-white/20 hover:text-white transition-colors">
                  <Pencil size={14} />
                </Link>
              </div>
            </div>
        ...
        <div className="bg-white/3 border border-white/8 rounded-2xl p-12 text-center">
          ...
          <Link href="/dashboard/services/new" className="text-[#26619C] hover:text-[#4a8fd4] text-sm transition-colors">
